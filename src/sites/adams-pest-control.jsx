// Layout: C | Industry: Pest Control | City: Little Rock
import { useState, useEffect } from "react";

// --- SVG Icon Components (no emojis, stroke-based, 28x28, strokeWidth 1.5) ---
const Icons = {
  phone: (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07 19.5 19.5 0 01-6-6 19.79 19.79 0 01-3.07-8.67A2 2 0 014.11 2h3a2 2 0 012 1.72c.127.96.361 1.903.7 2.81a2 2 0 01-.45 2.11L8.09 9.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0122 16.92z"/></svg>
  ),
  bug: (
    <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M8 2l1.88 1.88"/><path d="M14.12 3.88L16 2"/><path d="M9 7.13v-1a3.003 3.003 0 116 0v1"/><path d="M12 20c-3.3 0-6-2.7-6-6v-3a4 4 0 014-4h4a4 4 0 014 4v3c0 3.3-2.7 6-6 6z"/><path d="M12 20v-9"/><path d="M6.53 9C4.6 8.8 3 7.1 3 5"/><path d="M6 13H2"/><path d="M3 21c0-2.1 1.7-3.9 3.8-4"/><path d="M20.97 5c0 2.1-1.6 3.8-3.5 4"/><path d="M22 13h-4"/><path d="M17.2 17c2.1.1 3.8 1.9 3.8 4"/></svg>
  ),
  mosquito: (
    <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M12 22v-4"/><path d="M12 18a4 4 0 004-4v-1a2 2 0 00-2-2h-4a2 2 0 00-2 2v1a4 4 0 004 4z"/><path d="M12 11V2"/><path d="M8 11l-4-2"/><path d="M16 11l4-2"/><path d="M8 15l-5 2"/><path d="M16 15l5 2"/><path d="M9 2l3 3 3-3"/></svg>
  ),
  shield: (
  ...
  mouse: (
    <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M2 9a7 7 0 0112.9-3.8"/><path d="M8.5 9A6.5 6.5 0 0115 2.5C18.6 2.5 22 5.4 22 9c0 4.4-4 8-10 13C6 17 2 13.4 2 9z"/><circle cx="9" cy="8" r="1" fill="currentColor" stroke="none"/><path d="M2 14l2-2"/><path d="M2 10l2-1"/></svg>
  ),
  bed: (
    <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M2 4v16"/><path d="M2 8h18a2 2 0 012 2v10"/><path d="M2 17h20"/><path d="M6 8v3"/><path d="M8 4a2 2 0 012 2v2H6V6a2 2 0 012-2z"/></svg>
  ),
  building: (
...
// --- Data ---
const PHONE = "(501) 455-1065";
const PHONE_TEL = "tel:+15014551065";
const EMAIL = "CSR@adamspestcontrol.net";

const services = [
  { name: "General Pest Control", desc: "Comprehensive treatment for ants, roaches, spiders, and other common household pests. Adams technicians identify the source and eliminate the problem at its root, keeping your home pest-free year-round.", icon: Icons.bug },
  { name: "Mosquito Control", desc: "Targeted mosquito reduction treatments for your yard and outdoor living spaces. Enjoy your backyard again with regular spray programs designed for Arkansas humidity and mosquito seasons.", icon: Icons.mosquito },
  { name: "Termite Treatment", desc: "Full termite inspections and treatment plans to protect your home's structure. With nearly 70 years of experience, Adams catches termite activity early and eliminates colonies before serious damage occurs.", icon: Icons.shield },
  { name: "Rodent Control", desc: "Humane and effective rodent exclusion and removal for mice, rats, and other wildlife. We seal entry points and set up monitoring to keep your home rodent-free for good.", icon: Icons.mouse },
  { name: "Bed Bug Treatment", desc: "Thorough bed bug inspections and heat or chemical treatment plans tailored to your situation. Adams eliminates infestations completely so you can sleep easy again.", icon: Icons.bed },
  { name: "Commercial Pest Control", desc: "Custom pest management programs for offices, restaurants, warehouses, and commercial properties. Discreet, scheduled service that meets health code requirements and protects your business reputation.", icon: Icons.building },
];

const allServices = [
  "General Pest Control", "Mosquito Control", "Termite Treatment & Prevention",
  "Rodent Control", "Bed Bug Treatment", "Ant & Roach Control",
  "Quarterly Pest Plans", "Home Inspections", "Commercial Pest Control",
];

const reviews = [
  { text: "I have been with Adams Pest Control for years. I have never had a problem. I love my bug guy Tyler, he's the best. Whenever I call to schedule an appointment he calls sooner than later.", name: "Chanda Young-Olive", src: "Google" },
  { text: "We have been long time customer and very pleased with the services. Our technician, Lee is always going above and beyond.", name: "Jennifer Henard", src: "Google" },
  { text: "We have been very pleased with all of our services from Adams \u2014 Annual Termite, Quarterly Spraying and monthly Mosquito spray. Our technician, Arty, is easy to communicate with.", name: "Abbey Olberts", src: "Google" },
  { text: "Love Adams Pest control! Justin is our guy & he is punctual, great personality & just a joy to be around!", name: "Robin Machen", src: "Google" },
  { text: "Jason has been very reliable. He's timely to respond and address any concerns. Very pleased with Adams and the job they do.", name: "Tabitha Clarke", src: "Google" },
];

const areas = ["Little Rock", "Hot Springs", "White Hall", "Benton", "Sherwood", "North Little Rock", "Bryant", "Maumelle", "Searcy", "Central Arkansas"];

// --- Main Component ---
export default function AdamsPestControl() {
  const [authed, setAuthed] = useState(() => sessionStorage.getItem("adams-pest-auth") === "1");
  ...
  useEffect(() => {
    if (!authed) return;
    document.title = "Pest Control Little Rock AR | Adams Pest Control";
    const els = [];
    const add = (tag, attrs) => {
    ...
    add("meta", { name: "description", content: "Adams Pest Control \u2014 family-owned since 1957. 4.5 stars, 130+ reviews. Call (501) 455-1065 for a free quote in Little Rock, AR." });
    ...
    add("script", { type: "application/ld+json", textContent: JSON.stringify({
      ...
      name: "Adams Pest Control",
      telephone: "+15014551065",
      email: EMAIL,
      address: { "@type": "PostalAddress", streetAddress: "12324 Stagecoach Rd", addressLocality: "Little Rock", addressRegion: "AR", postalCode: "72210", addressCountry: "US" },
      geo: { "@type": "GeoCoordinates", latitude: 34.7465, longitude: -92.2896 },
      openingHoursSpecification: [{ "@type": "OpeningHoursSpecification", dayOfWeek: ["Monday","Tuesday","Wednesday","Thursday","Friday"], opens: "08:00", closes: "17:00" }],
      aggregateRating: { "@type": "AggregateRating", ratingValue: "4.5", reviewCount: "130", bestRating: "5" },
      founder: { "@type": "Person", name: "Tim Adams" },
      foundingDate: "1957",
      description: "Adams Pest Control is a family-owned pest control company serving Little Rock and central Arkansas since 1957. Three generations of the Adams family, BBB A+ accredited since 1993.",
      areaServed: areas.map((a) => ({ "@type": "City", name: a })),
      hasOfferCatalog: { "@type": "OfferCatalog", name: "Pest Control Services", itemListElement: allServices.map((s) => ({ "@type": "Offer", itemOffered: { "@type": "Service", name: s } })) },
        ...
        <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "#1E3A2F" }}>
          <div style={{ background: "#fff", borderRadius: 16, padding: "56px 44px", textAlign: "center", maxWidth: 420, width: "92%", boxShadow: "0 32px 80px rgba(0,0,0,.35)" }}>
            <div style={{ fontFamily: "'Playfair Display',serif", fontSize: 28, fontWeight: 600, letterSpacing: -0.5, marginBottom: 4 }}>
              <span style={{ color: "#1E3A2F" }}>Adams</span> <span style={{ color: "#B8694A" }}>Pest Control</span>
            </div>
    ...
    <>
      ...
      <nav style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 1000, padding: scrolled ? "14px clamp(24px,5vw,64px)" : "20px clamp(24px,5vw,64px)", display: "flex", alignItems: "center", justifyContent: "space-between", background: scrolled ? "rgba(30,58,47,0.97)" : "transparent", backdropFilter: scrolled ? "blur(12px)" : "none", transition: "all 0.4s ease", boxShadow: scrolled ? "0 1px 0 rgba(255,255,255,0.06)" : "none" }}>
        <div className="serif" style={{ fontSize: 22, fontWeight: 600, letterSpacing: -0.5, color: "#fff" }}>
          <span>Adams</span><span style={{ color: "var(--accent)", marginLeft: 6 }}>Pest Control</span>
        </div>
        ...
        <div className="hero-grid" style={{ maxWidth: 1200, width: "100%", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64, alignItems: "center" }}>
          ...
          <div style={{ maxWidth: 560 }}>
            <div style={{ display: "inline-flex", alignItems: "center", gap: 8, background: "rgba(255,255,255,0.1)", padding: "8px 18px", borderRadius: 4, marginBottom: 28 }}>
              ...
              <span style={{ fontSize: 12, fontWeight: 700, letterSpacing: 3, textTransform: "uppercase", color: "var(--accent)" }}>Family Owned Since 1957</span>
            </div>
            <h1 style={{ fontFamily: "'Playfair Display',serif", fontSize: "clamp(40px,5vw,68px)", lineHeight: 1.05, letterSpacing: -1.5, color: "#fff", marginBottom: 24 }}>
              Little Rock's{" "}<br/>
              <em style={{ color: "var(--accent)", fontStyle: "italic" }}>Trusted Pest Control</em><br/>
              Since 1957
            </h1>
            <p style={{ fontSize: 18, lineHeight: 1.7, color: "rgba(255,255,255,0.75)", marginBottom: 32, maxWidth: 480 }}>
              Three generations of the Adams family protecting Arkansas homes and businesses. BBB A+ accredited since 1993, with three locations serving central Arkansas.
            </p>
            {/* Star row with hero quote */}
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 32, flexWrap: "wrap" }}>
              <Stars />
              <span style={{ fontSize: 14, color: "rgba(255,255,255,0.7)", fontStyle: "italic" }}>"Long time customer. Lee is always going above and beyond."</span>
              <span style={{ fontSize: 13, color: "rgba(255,255,255,0.5)" }}>- Jennifer Henard</span>
            </div>
      ...
      <section style={{ background: "var(--white)", padding: "48px clamp(24px,5vw,64px)" }}>
        <div className="trust-grid" style={{ maxWidth: 1200, margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 32, textAlign: "center" }}>
          {[
            ...
            { num: "130+", label: "Reviews", desc: "Happy customers" },
            { num: "70", label: "Years", desc: "Since 1957" },
            { num: "A+", label: "BBB Rating", desc: "Since 1993" },
          ].map((s, i) => (
      ...
      <section id="services" className="section-pad" style={{ padding: "110px clamp(24px,5vw,64px)", background: "var(--cream)" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 64 }}>
            ...
            <h2 style={{ fontFamily: "'Playfair Display',serif", fontSize: "clamp(30px,3.5vw,44px)", lineHeight: 1.15, letterSpacing: -0.5, color: "var(--primary)" }}>Pest Control Services in Little Rock</h2>
          </div>
          {services.map((svc, i) => {
            const isEven = i % 2 === 1;
            return (
          ...
          <p style={{ textAlign: "center", marginTop: 48, fontSize: 15, color: "var(--text-mid)" }}>
            Questions? Call Tim directly at <a href={PHONE_TEL} style={{ color: "var(--accent)", fontWeight: 600 }}>{PHONE}</a>
          </p>
        </div>
      </section>
      ...
      <section id="about" className="section-pad" style={{ padding: "110px clamp(24px,5vw,64px)", background: "var(--cream)" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 64 }}>
            <div className="gold-line" />
            <p style={{ fontSize: 12, fontWeight: 700, letterSpacing: 3, textTransform: "uppercase", color: "var(--text-light)", marginBottom: 14, fontFamily: "'DM Sans',sans-serif" }}>Why Adams</p>
            <h2 style={{ fontFamily: "'Playfair Display',serif", fontSize: "clamp(30px,3.5vw,44px)", lineHeight: 1.15, letterSpacing: -0.5, color: "var(--primary)" }}>Three Generations Protecting Arkansas Homes</h2>
          </div>
          <div className="why-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64, alignItems: "start" }}>
            ...
            <div>
              <p style={{ fontSize: 17, lineHeight: 1.8, color: "var(--text-mid)", marginBottom: 20 }}>
                The Adams family has been keeping Arkansas homes and businesses pest-free since 1957. What started as one man's commitment to honest, reliable service has grown into a three-generation operation led by Tim Adams, with locations in Little Rock, Hot Springs, and White Hall.
              </p>
              <p style={{ fontSize: 17, lineHeight: 1.8, color: "var(--text-mid)", marginBottom: 32 }}>
                Nearly 70 years later, the same values hold true. Customers stay with Adams for years, and they know their technicians by name. Tyler, Lee, Arty, Justin, Jason, Marvin — these aren't just employees, they're the people your family trusts to keep your home safe. That kind of relationship doesn't happen by accident.
              </p>
              {/* Pull quote */}
              <div style={{ borderLeft: "3px solid var(--accent)", paddingLeft: 24, marginBottom: 36 }}>
                <p style={{ fontSize: 18, fontStyle: "italic", lineHeight: 1.7, color: "var(--primary)", fontFamily: "'Playfair Display',serif" }}>
                  "I love my bug guy Tyler, he's the best."
                </p>
                <p style={{ fontSize: 14, color: "var(--text-light)", marginTop: 8, fontFamily: "'DM Sans',sans-serif" }}>- Chanda Young-Olive, Google Review</p>
              </div>
              {/* Credentials */}
              <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
                {[
                  "BBB A+ Accredited Since 1993",
                  "Family Owned Since 1957",
                  "Three Generations of the Adams Family",
                  "3 Locations Across Central Arkansas",
                  "6+ Named Technicians Customers Know By Name",
                  "Mon-Fri 8AM-5PM Service",
                ].map((cred, i) => (
            ...
            <div className="badge-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }}>
              {[
                { icon: Icons.home, title: "Three Generations", desc: "The Adams family has protected Arkansas homes since 1957. Nearly 70 years of experience passed down through three generations." },
                { icon: Icons.award, title: "BBB A+ Since 1993", desc: "Over three decades of Better Business Bureau accreditation. A track record of trust, integrity, and customer satisfaction." },
                { icon: Icons.users, title: "Technicians You Know", desc: "Tyler, Lee, Arty, Justin, Jason, Marvin. Customers stay for years because they trust the people Adams sends to their home." },
                { icon: Icons.clock, title: "3 Locations", desc: "Little Rock, Hot Springs, and White Hall. Wherever you are in central Arkansas, Adams has a team nearby ready to help." },
              ].map((b, i) => (
      ...
      <section id="reviews" className="section-pad" style={{ padding: "110px clamp(24px,5vw,64px)", background: "var(--white)" }}>
        <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center" }}>
          ...
          {/* Large featured review — Abbey Olberts */}
          <div style={{ position: "relative", padding: "48px 40px", background: "var(--white)", borderRadius: 12 }}>
            ...
            <p style={{ fontSize: 20, lineHeight: 1.8, color: "var(--text)", fontStyle: "italic", fontFamily: "'Playfair Display',serif", marginBottom: 28 }}>
              "We have been very pleased with all of our services from Adams — Annual Termite, Quarterly Spraying and monthly Mosquito spray. Our technician, Arty, is easy to communicate with."
            </p>
            <p style={{ fontSize: 17, fontWeight: 700, color: "var(--primary)" }}>Abbey Olberts</p>
            <p style={{ fontSize: 13, color: "var(--text-light)", marginTop: 4 }}>Google Review</p>
          </div>
          <p style={{ fontSize: 14, color: "var(--text-light)", marginTop: 32 }}>One of 130+ five-star reviews on Google</p>
      ...
      <section id="areas" className="section-pad" style={{ padding: "110px clamp(24px,5vw,64px)", background: "var(--cream)" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto", textAlign: "center" }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: 12, justifyContent: "center" }}>
            {areas.map((area, i) => (
              <span key={i} title={`Pest Control in ${area}, AR`} style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "12px 22px", background: "var(--white)", border: "1px solid var(--border)", borderRadius: 100, fontSize: 14, fontWeight: 500, color: "var(--text)", cursor: "default", transition: "all 0.2s ease", fontFamily: "'DM Sans',sans-serif" }}
      ...
      <section className="section-pad" style={{ padding: "110px clamp(24px,5vw,64px)", background: "var(--white)", borderTop: "1px solid var(--border)" }}>
        <div style={{ maxWidth: 700, margin: "0 auto", textAlign: "center" }}>
          <h2 style={{ fontFamily: "'Playfair Display',serif", fontSize: "clamp(30px,3.5vw,44px)", lineHeight: 1.15, letterSpacing: -0.5, color: "var(--primary)", marginBottom: 20 }}>
            Got unwanted guests?<br/><em style={{ color: "var(--accent)", fontStyle: "italic" }}>Call Adams.</em>
          </h2>
          <p style={{ fontSize: 17, lineHeight: 1.7, color: "var(--text-mid)", marginBottom: 40, maxWidth: 520, margin: "0 auto 40px" }}>
            Three generations of honest, reliable pest control. No contracts required, no surprise charges. Just the Adams family doing what they've done best since 1957.
          </p>
      ...
      <footer style={{ background: "var(--primary)", padding: "80px clamp(24px,5vw,64px) 40px", color: "rgba(255,255,255,0.75)" }}>
        <div className="footer-grid" style={{ maxWidth: 1200, margin: "0 auto", display: "grid", gridTemplateColumns: "1.4fr 1fr 1fr", gap: 48, marginBottom: 48 }}>
          ...
          <div>
            ...
            <p style={{ fontSize: 15, lineHeight: 1.7, marginBottom: 20, maxWidth: 300 }}>
              Family-owned pest control serving central Arkansas since 1957. Three generations of trusted service.
            </p>
            <p style={{ fontSize: 14, marginBottom: 8 }}>12324 Stagecoach Rd, Little Rock, AR 72210</p>
        ...
        <div style={{ borderTop: "1px solid rgba(255,255,255,0.1)", paddingTop: 24 }}>
          <div className="footer-btm-inner" style={{ maxWidth: 1200, margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            <p style={{ fontSize: 13, color: "rgba(255,255,255,0.4)" }}>© {new Date().getFullYear()} Adams Pest Control. All rights reserved.</p>
            <p style={{ fontSize: 13, color: "rgba(255,255,255,0.4)" }}>BBB Accredited Business | A+ Rating Since 1993</p>
          </div>
        </div>
      </footer>

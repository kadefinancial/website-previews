// Layout: C | Industry: Electrician | City: Cabot
...
// --- Data ---
const PHONE = "(501) 422-3132";
const PHONE_TEL = "tel:+15014223132";
const EMAIL = "help@hertzar.com";

const services = [
  { name: "Residential Electrical", desc: "Complete electrical services for your home, from outlet installation and wiring upgrades to whole-house rewiring. Safe, code-compliant work every time.", icon: Icons.home },
  { name: "Commercial Electrical", desc: "Reliable electrical solutions for businesses across central Arkansas. We handle everything from office buildouts to industrial electrical systems.", icon: Icons.building },
  { name: "Panel Upgrades", desc: "Outdated or overloaded panel? We upgrade your electrical panel and breaker service to meet modern demands safely and efficiently.", icon: Icons.panel },
  { name: "Lighting Installation", desc: "From recessed lighting and fixtures to landscape and accent lighting, we design and install solutions that transform your space.", icon: Icons.lightbulb },
  { name: "Emergency Electrical (24/7)", desc: "Electrical emergencies don't wait, and neither do we. Available around the clock for urgent repairs, outages, and safety hazards.", icon: Icons.zap },
  { name: "Smart Home Installation", desc: "Smart dimmers, switches, thermostats, and whole-home automation installed correctly by licensed electricians who know the technology.", icon: Icons.smartHome },
];
...
const allServices = [
  ...
  "Panel Upgrades & Breaker Service",
  "Smart Home Installation",
  "Ceiling Fan Installation",
  "Generator Service",
  "Home Warranty Electrical Work",
];

const reviews = [
  { text: "Lightning struck my home and there were so many issues. Levi is the best. He's very professional, knowledgeable, and thorough.", name: "Kathy Ring", src: "Google" },
  { text: "Levi was great at troubleshooting the issue and explaining his troubleshooting steps. He was able to diagnose and resolve the problem quickly.", name: "Jeremy Carper", src: "Google" },
  { text: "We had several fixtures that we wanted upgraded. Hertz was highly competitive, super responsive, and the work was excellent.", name: "Bill Armstrong", src: "Google" },
  { text: "Excellent service. Levi was knowledgeable, polite, and kind. He did a fantastic job.", name: "Elizabeth Mowan", src: "Google" },
  { text: "I began a project to convert my home to smart dimmers and switches. I very quickly got in over my head. Hertz sorted it out quickly.", name: "John Hunt", src: "Google" },
];

const areas = ["Cabot", "Little Rock", "North Little Rock", "Sherwood", "Jacksonville", "Beebe", "Lonoke", "Ward", "Austin", "Searcy"];

// --- Main Component ---
export default function HertzElectric() {
  const [authed, setAuthed] = useState(() => sessionStorage.getItem("hertz-auth") === "1");
  ...
  useEffect(() => {
    if (!authed) return;
    document.title = "Electrician Cabot AR | Hertz Electric";
    const els = [];
    ...
    add("meta", { name: "description", content: "Licensed electrician in Cabot, AR. 5.0 stars, 208+ reviews. Call (501) 422-3132 for residential and commercial electrical service." });
    ...
    add("script", { type: "application/ld+json", textContent: JSON.stringify({
      ...
      name: "Hertz Electric", telephone: "+15014223132",
      email: "help@hertzar.com",
      address: { "@type": "PostalAddress", streetAddress: "27205 AR-107", addressLocality: "Cabot", addressRegion: "AR", postalCode: "72023", addressCountry: "US" },
      geo: { "@type": "GeoCoordinates", latitude: 34.953, longitude: -92.016 },
      openingHoursSpecification: [
        { "@type": "OpeningHoursSpecification", dayOfWeek: ["Monday","Tuesday","Wednesday","Thursday","Friday"], opens: "08:00", closes: "17:00" },
      ],
      aggregateRating: { "@type": "AggregateRating", ratingValue: "5.0", reviewCount: "208", bestRating: "5" },
      description: "Hertz Electric is a licensed electrical contractor in Cabot, AR, providing residential and commercial electrical services, 24/7 emergency repairs, panel upgrades, and smart home installation across central Arkansas.",
        ...
        <div style={{ minHeight:"100vh", display:"flex", alignItems:"center", justifyContent:"center", background:"#2D2D2D" }}>
          <div style={{ background:"#fff", borderRadius:16, padding:"56px 44px", textAlign:"center", maxWidth:420, width:"92%", boxShadow:"0 32px 80px rgba(0,0,0,.35)" }}>
            <div style={{ fontFamily:"'Playfair Display',serif", fontSize:28, fontWeight:600, letterSpacing:-0.5, marginBottom:4 }}>
              <span style={{ color:"#2D2D2D" }}>Hertz</span> <span style={{ color:"#D4A03C" }}>Electric</span>
            </div>
    ...
    <>
      ...
      <nav style={{ position:"fixed", top:0, left:0, right:0, zIndex:1000, padding: scrolled ? "14px clamp(24px,5vw,64px)" : "20px clamp(24px,5vw,64px)", display:"flex", alignItems:"center", justifyContent:"space-between", background: scrolled ? "rgba(45,45,45,0.97)" : "transparent", backdropFilter: scrolled ? "blur(12px)" : "none", transition:"all 0.4s ease", boxShadow: scrolled ? "0 1px 0 rgba(255,255,255,0.06)" : "none" }}>
        <div className="serif" style={{ fontSize:22, fontWeight:600, letterSpacing:-0.5, color:"#fff" }}>
          <span>Hertz</span><span style={{ color:"var(--accent)", marginLeft:6 }}>Electric</span>
        </div>
        ...
        <div className="hero-grid" style={{ maxWidth:1200, width:"100%", display:"grid", gridTemplateColumns:"1fr 1fr", gap:64, alignItems:"center" }}>
          ...
          <div style={{ maxWidth:560 }}>
            ...
            <h1 style={{ fontFamily:"'Playfair Display',serif", fontSize:"clamp(40px,5vw,68px)", lineHeight:1.05, letterSpacing:-1.5, color:"#fff", marginBottom:24 }}>
              Cabot's{" "}<br/>
              <em style={{ color:"var(--accent)", fontStyle:"italic" }}>Go-To Electrician</em><br/>
              24/7
            </h1>
            <p style={{ fontSize:18, lineHeight:1.7, color:"rgba(255,255,255,0.75)", marginBottom:32, maxWidth:480 }}>
              Licensed electrical service for homes and businesses across central Arkansas. From panel upgrades to smart home installs, the Hertz team delivers precise, code-compliant work and a perfect 5.0-star reputation.
            </p>
            {/* Star row with hero quote */}
            <div style={{ display:"flex", alignItems:"center", gap:12, marginBottom:32, flexWrap:"wrap" }}>
              <Stars />
              <span style={{ fontSize:14, color:"rgba(255,255,255,0.7)", fontStyle:"italic" }}>"Levi is the best. Very professional, knowledgeable, and thorough."</span>
              <span style={{ fontSize:13, color:"rgba(255,255,255,0.5)" }}>- Kathy Ring</span>
            </div>
      ...
      <section style={{ background:"var(--white)", padding:"48px clamp(24px,5vw,64px)" }}>
        <div className="trust-grid" style={{ maxWidth:1200, margin:"0 auto", display:"grid", gridTemplateColumns:"repeat(4,1fr)", gap:32, textAlign:"center" }}>
          {[
            ...
            { num: "208+", label: "Reviews", desc: "Happy customers" },
            { num: "24/7", label: "Emergency", desc: "Always available" },
            { num: "Smart", label: "Home Pros", desc: "Modern solutions" },
          ].map((s, i) => (
      ...
      <section id="services" className="section-pad" style={{ padding:"110px clamp(24px,5vw,64px)", background:"var(--cream)" }}>
        <div style={{ maxWidth:1200, margin:"0 auto" }}>
          <div style={{ textAlign:"center", marginBottom:64 }}>
            ...
            <h2 style={{ fontFamily:"'Playfair Display',serif", fontSize:"clamp(30px,3.5vw,44px)", lineHeight:1.15, letterSpacing:-0.5, color:"var(--primary)" }}>Electrical Services in Cabot</h2>
          </div>
          {services.map((svc, i) => {
            const isEven = i % 2 === 1;
            return (
      ...
      <section id="about" className="section-pad" style={{ padding:"110px clamp(24px,5vw,64px)", background:"var(--cream)" }}>
        <div style={{ maxWidth:1200, margin:"0 auto" }}>
          <div style={{ textAlign:"center", marginBottom:64 }}>
            <div className="gold-line" />
            <p style={{ fontSize:12, fontWeight:700, letterSpacing:3, textTransform:"uppercase", color:"var(--text-light)", marginBottom:14, fontFamily:"'DM Sans',sans-serif" }}>Why Hertz</p>
            <h2 style={{ fontFamily:"'Playfair Display',serif", fontSize:"clamp(30px,3.5vw,44px)", lineHeight:1.15, letterSpacing:-0.5, color:"var(--primary)" }}>A Perfect 5.0 Across 208 Reviews</h2>
          </div>
          <div className="why-grid" style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:64, alignItems:"start" }}>
            ...
            <div>
              <p style={{ fontSize:17, lineHeight:1.8, color:"var(--text-mid)", marginBottom:20 }}>
                Hertz Electric has built a flawless reputation across central Arkansas, and their customers will tell you exactly why. With a perfect 5.0-star rating from 208 reviews, this is a team that gets it right every single time.
              </p>
              <p style={{ fontSize:17, lineHeight:1.8, color:"var(--text-mid)", marginBottom:32 }}>
                Customers consistently single out Levi as the star technician -- professional, knowledgeable, and thorough. Nate Warren brings deep electrical expertise, while the office team, including Neil on phones and Lacey on scheduling, earns praise for communication that makes the entire experience seamless. Available 24/7 for emergencies, Hertz Electric is the call central Arkansas makes when the job has to be done right.
              </p>
              {/* Pull quote */}
              <div style={{ borderLeft:"3px solid var(--accent)", paddingLeft:24, marginBottom:36 }}>
                <p style={{ fontSize:18, fontStyle:"italic", lineHeight:1.7, color:"var(--primary)", fontFamily:"'Playfair Display',serif" }}>
                  "I got in over my head. Hertz sorted it out quickly."
                </p>
                <p style={{ fontSize:14, color:"var(--text-light)", marginTop:8, fontFamily:"'DM Sans',sans-serif" }}>- John Hunt, Google Review</p>
              </div>
              {/* Credentials */}
              <div style={{ display:"flex", flexDirection:"column", gap:14 }}>
                {[
                  "Perfect 5.0-Star Google Rating",
                  "208+ Verified Customer Reviews",
                  "24/7 Emergency Electrical Service",
                  "Residential & Commercial Licensed",
                  "Smart Home Installation Experts",
                  "Mon-Fri 8AM-5PM + Emergency Availability",
                ].map((cred, i) => (
            ...
            <div className="badge-grid" style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:20 }}>
              {[
                { icon: Icons.award, title: "Perfect 5.0 Rating", desc: "208 reviews and every single one is five stars. That kind of consistency speaks for itself." },
                { icon: Icons.users, title: "Team You Can Trust", desc: "Levi, Nate, Neil, and Lacey -- every member of the Hertz team is praised by name in customer reviews." },
                { icon: Icons.zap, title: "24/7 Emergency", desc: "Electrical emergencies don't follow business hours. Hertz Electric is available around the clock when you need them most." },
                { icon: Icons.smartHome, title: "Smart Home Pros", desc: "From smart dimmers to whole-home automation, the Hertz team installs modern electrical technology the right way." },
              ].map((b, i) => (
      ...
      <section id="reviews" className="section-pad" style={{ padding:"110px clamp(24px,5vw,64px)", background:"var(--white)" }}>
        <div style={{ maxWidth:800, margin:"0 auto", textAlign:"center" }}>
          ...
          {/* Large featured review — Bill Armstrong */}
          <div style={{ position:"relative", padding:"48px 40px", background:"var(--white)", borderRadius:12 }}>
            ...
            <p style={{ fontSize:20, lineHeight:1.8, color:"var(--text)", fontStyle:"italic", fontFamily:"'Playfair Display',serif", marginBottom:28 }}>
              "We had several fixtures that we wanted upgraded. Hertz was highly competitive, super responsive, and the work was excellent."
            </p>
            <p style={{ fontSize:17, fontWeight:700, color:"var(--primary)" }}>Bill Armstrong</p>
            <p style={{ fontSize:13, color:"var(--text-light)", marginTop:4 }}>Google Review</p>
          </div>
          <p style={{ fontSize:14, color:"var(--text-light)", marginTop:32 }}>One of 208+ five-star reviews on Google</p>
      ...
      <section className="section-pad" style={{ padding:"110px clamp(24px,5vw,64px)", background:"var(--white)", borderTop:"1px solid var(--border)" }}>
        <div style={{ maxWidth:700, margin:"0 auto", textAlign:"center" }}>
          <h2 style={{ fontFamily:"'Playfair Display',serif", fontSize:"clamp(30px,3.5vw,44px)", lineHeight:1.15, letterSpacing:-0.5, color:"var(--primary)", marginBottom:20 }}>
            Need an electrician?<br/><em style={{ color:"var(--accent)", fontStyle:"italic" }}>Call Hertz Electric.</em>
          </h2>
          <p style={{ fontSize:17, lineHeight:1.7, color:"var(--text-mid)", marginBottom:36, maxWidth:520, margin:"0 auto 36px" }}>
            A perfect 5.0-star rating from 208 customers. Licensed electrical work, honest pricing, and 24/7 emergency availability across central Arkansas.
          </p>
          ...
          <p style={{ fontSize:14, color:"var(--text-light)", marginTop:20 }}>Or email <a href="mailto:help@hertzar.com" style={{ color:"var(--accent)", fontWeight:600 }}>{EMAIL}</a></p>
        </div>
      </section>
      ...
      <footer style={{ background:"var(--primary)", padding:"80px clamp(24px,5vw,64px) 40px", color:"rgba(255,255,255,0.7)" }}>
        <div className="footer-grid" style={{ maxWidth:1200, margin:"0 auto", display:"grid", gridTemplateColumns:"1.5fr 1fr 1fr", gap:48, marginBottom:48 }}>
          ...
          <div>
            ...
            <p style={{ fontSize:14, lineHeight:1.7, marginBottom:20, maxWidth:300 }}>
              Licensed electrical contractor in Cabot, AR. Perfect 5.0-star rating from 208+ customers across central Arkansas. Residential, commercial, and 24/7 emergency service.
            </p>
          ...
          <div>
            ...
            <ul style={{ listStyle:"none", display:"flex", flexDirection:"column", gap:10 }}>
              {["Residential Electrical","Commercial Electrical","Panel Upgrades","Lighting Installation","Emergency Electrical","Smart Home Installation"].map((s, i) => (
        ...
        <div style={{ borderTop:"1px solid rgba(255,255,255,0.1)", paddingTop:24 }}>
          <div className="footer-btm-inner" style={{ maxWidth:1200, margin:"0 auto", display:"flex", justifyContent:"space-between", alignItems:"center", fontSize:13, color:"rgba(255,255,255,0.45)" }}>
            <span>&copy; {new Date().getFullYear()} Hertz Electric. All rights reserved.</span>
      ...
      <div className="mobile-only" style={{ position:"fixed", bottom:0, left:0, right:0, zIndex:998, display:"none" }}>
        <a href={PHONE_TEL} style={{ display:"flex", alignItems:"center", justifyContent:"center", gap:10, background:"var(--accent)", color:"#fff", padding:"18px 24px", fontSize:16, fontWeight:700, fontFamily:"'DM Sans',sans-serif", boxShadow:"0 -4px 20px rgba(0,0,0,0.15)", textDecoration:"none" }}>
          {Icons.phone} Call Hertz Electric
        </a>
      </div>

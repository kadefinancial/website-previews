...
const PHONE = "(501) 851-2202";
const TEL = "tel:+15018512202";
...
const services = [
  { name: "Air Conditioning Installation & Repair", desc: "Complete AC installation and expert repair for all makes and models. From new system sizing to emergency fixes, we keep your home cool when it matters most.", icon: Icons.snowflake },
  { name: "Heating / Furnace Installation & Repair", desc: "Professional furnace and heating system installation and repair. Our technicians diagnose and fix the problem right the first time, keeping your family warm all winter.", icon: Icons.flame },
  { name: "HVAC System Maintenance", desc: "Preventative tune-ups that extend the life of your system, lower energy bills, and catch small issues before they become expensive repairs.", icon: Icons.wind },
  { name: "Yearly Maintenance Plans", desc: "Affordable annual plans that protect your investment with scheduled inspections and priority service. Peace of mind for your home comfort year-round.", icon: Icons.clipboard },
  { name: "Residential HVAC", desc: "Full-service heating and cooling for homes of all sizes throughout Central Arkansas. The Kirby family treats your home like their own.", icon: Icons.home },
  { name: "Commercial HVAC", desc: "Reliable commercial heating and cooling solutions for businesses and organizations. Trusted by local churches, offices, and commercial properties.", icon: Icons.building },
];
...
const areas = ["North Little Rock", "Maumelle", "Central Arkansas"];

const reviews = [
  { text: "Kirby Heat and Air have been incredible. They are fair, prompt, professional, and extremely kind. They are who we call for all our HVAC for our home and church. A special thank you to Brian Kirby for being the best technician we have ever worked with!", name: "Taylor Hinkle", src: "Google" },
  { text: "Big thank you to Joe and the rest of the Kirby team! Would recommend.", name: "Clay Pearson", src: "Google" },
];
...
export default function KirbysHeatingAndAirConditioning() {
  const [authed, setAuthed] = useState(() => sessionStorage.getItem("kirbys-hvac-auth") === "1");
  ...
  const submitPw = (e) => {
    e.preventDefault();
    if (pw === "roof") { sessionStorage.setItem("kirbys-hvac-auth", "1"); setAuthed(true); }
  ...
  useEffect(() => {
    if (!authed) return;
    document.title = "HVAC Service North Little Rock AR | Kirby's Heating & Air";
    const els = [];
    const add = (tag, attrs) => {
    ...
    add("meta", { name: "description", content: "Family-owned HVAC service in North Little Rock, AR. 50+ years, 22+ reviews. Call (501) 851-2202 for heating & AC." });
    ...
    add("script", {
      ...
      textContent: JSON.stringify({
        ...
        "@type": "HVACBusiness",
        name: "Kirby's Heating & Air Conditioning Inc",
        telephone: "+15018512202",
        address: { "@type": "PostalAddress", streetAddress: "12006 MacArthur Dr", addressLocality: "North Little Rock", addressRegion: "AR", postalCode: "72118", addressCountry: "US" },
        geo: { "@type": "GeoCoordinates", latitude: 34.8029, longitude: -92.2570 },
        ...
        aggregateRating: { "@type": "AggregateRating", ratingValue: "4.3", reviewCount: "22", bestRating: "5" },
        description: "Family-owned HVAC service in North Little Rock, AR for over 50 years. Residential and commercial heating and air conditioning installation, repair, and maintenance.",
        ...
        <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "#1C2B41" }}>
          <div style={{ background: "#fff", borderRadius: 16, padding: "56px 44px", textAlign: "center", maxWidth: 420, width: "92%", boxShadow: "0 32px 80px rgba(0,0,0,.35)" }}>
            <div style={{ fontFamily: "'Playfair Display',serif", fontSize: 28, marginBottom: 8, fontWeight: 600, letterSpacing: -0.5 }}>
              <span style={{ color: "#1C2B41" }}>Kirby's</span>{" "}
              <span style={{ color: "#8B3A3A" }}>Heating & Air</span>
            </div>
    ...
    <>
        ...
        <div className="hero-grid" style={{ maxWidth: 1200, width: "100%", display: "grid", gridTemplateColumns: "1.2fr 1fr", gap: 48, alignItems: "center" }}>
          <div>
            <div style={{ display: "inline-flex", alignItems: "center", gap: 8, background: "rgba(139,58,58,0.1)", padding: "8px 16px", borderRadius: 40, marginBottom: 24 }}>
              <Stars />
              <span style={{ fontSize: 13, fontWeight: 600, color: "var(--accent)" }}>50+ Years Family Owned</span>
            </div>
            <h1 style={{ fontSize: "clamp(40px,5vw,68px)", lineHeight: 1.05, color: "var(--primary)", letterSpacing: -1.5, marginBottom: 20 }}>
              North Little Rock's<br /><span style={{ fontStyle: "italic", color: "var(--accent)" }}>Trusted Family</span><br />HVAC Experts
            </h1>
            <p style={{ fontSize: 18, lineHeight: 1.7, color: "var(--text-mid)", maxWidth: 480, marginBottom: 28 }}>
              The Kirby family has kept Central Arkansas comfortable for over 50 years. Fair pricing, honest work, and a team that treats your home like their own.
            </p>
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 32 }}>
              <Stars />
              <span style={{ fontSize: 14, color: "var(--text-light)", fontStyle: "italic", marginLeft: 4 }}>"The best technician we have ever worked with!" — Taylor Hinkle</span>
            </div>
      ...
      <section style={{ background: "var(--white)", borderTop: "1px solid var(--border)", borderBottom: "1px solid var(--border)", padding: "48px clamp(24px,5vw,64px)" }}>
        <div className="trust-row" style={{ maxWidth: 1200, margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 32, textAlign: "center" }}>
          {[
            { num: "50+", label: "Years in Business", desc: "Family-owned since the 1970s" },
            { num: "22+", label: "Customer Reviews", desc: "On Google" },
            { num: "Family", label: "Owned & Operated", desc: "The Kirby family" },
            { num: "Inc.", label: "Incorporated Business", desc: "Established & trusted" },
          ].map((s, i) => (
            <div key={i}>
      ...
      <section id="services" style={{ padding: "110px clamp(24px,5vw,64px)", background: "var(--cream)" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          <p style={{ textAlign: "center", marginTop: 40, fontSize: 15, color: "var(--text-mid)" }}>
            Questions? Call the Kirby family directly at <a href={TEL} style={{ color: "var(--accent)", fontWeight: 700 }}>{PHONE}</a>
          </p>
        </div>
      </section>
      ...
      <section id="about" style={{ padding: "110px clamp(24px,5vw,64px)", background: "var(--primary)" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 64 }}>
            <div className="gold-line" style={{ margin: "0 auto 20px" }} />
            <div style={{ fontSize: 12, fontWeight: 700, textTransform: "uppercase", letterSpacing: 3, color: "var(--accent)", marginBottom: 14 }}>Why Kirby's</div>
            <h2 style={{ fontSize: "clamp(30px,3.5vw,44px)", color: "#fff", letterSpacing: -0.5 }}>Over 50 Years of Family Service</h2>
          </div>
          <div className="why-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 56, alignItems: "start" }}>
            <div>
              <p style={{ fontSize: 17, lineHeight: 1.8, color: "rgba(255,255,255,0.82)", marginBottom: 20 }}>
                Kirby's Heating & Air Conditioning has been a family-owned and operated business in North Little Rock for over 50 years. What started as one family's commitment to honest, reliable HVAC work has grown into a trusted name across Central Arkansas — but the values have never changed.
              </p>
              <p style={{ fontSize: 17, lineHeight: 1.8, color: "rgba(255,255,255,0.82)", marginBottom: 32 }}>
                When you call Kirby's, you get real family members working on your system. Brian Kirby is a hands-on technician praised by customers as "the best technician we have ever worked with." That personal touch — knowing the person in your home genuinely cares about getting it right — is what sets Kirby's apart.
              </p>
              <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
                {[
                  "Family owned and operated for over 50 years",
                  "Brian Kirby — family member and lead technician",
                  "Incorporated business — established and trusted",
                  "Fair, reasonable pricing on every job",
                  "Yearly maintenance plans available",
                  "Mon-Fri 8AM-4:30PM service hours",
                ].map((c, i) => (
            ...
            <div className="badge-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }}>
              {[
                { icon: Icons.users, title: "Family Owned", desc: "Over 50 years of Kirby family service in Central Arkansas" },
                { icon: Icons.shield, title: "Incorporated", desc: "Established Inc. business you can trust" },
                { icon: Icons.heart, title: "Brian Kirby", desc: "Family member praised as the best technician" },
                { icon: Icons.dollar, title: "Fair Pricing", desc: "Honest, reasonable pricing on every job" },
              ].map((b, i) => (
      ...
      <section style={{ padding: "110px clamp(24px,5vw,64px)", background: "var(--white)", borderTop: "1px solid var(--border)" }}>
        <div style={{ maxWidth: 700, margin: "0 auto", textAlign: "center" }}>
          <h2 style={{ fontSize: "clamp(30px,3.5vw,44px)", color: "var(--primary)", letterSpacing: -0.5, lineHeight: 1.15, marginBottom: 20 }}>
            Need heating or cooling help?<br /><span style={{ fontStyle: "italic", color: "var(--accent)" }}>Call the Kirby family.</span>
          </h2>
          <p style={{ fontSize: 17, lineHeight: 1.7, color: "var(--text-mid)", marginBottom: 36, maxWidth: 520, margin: "0 auto 36px" }}>
            Over 50 years of honest, fair-priced HVAC service. Family owned. Incorporated. Trusted by North Little Rock families and businesses.
          </p>
      ...
      <footer style={{ background: "var(--primary)", padding: "80px clamp(24px,5vw,64px) 40px" }}>
        <div className="footer-grid" style={{ maxWidth: 1200, margin: "0 auto", display: "grid", gridTemplateColumns: "1.4fr 1fr 1fr", gap: 48, marginBottom: 48 }}>
          <div>
            <div className="serif" style={{ fontSize: 22, fontWeight: 600, letterSpacing: -0.5, marginBottom: 16 }}>
              <span style={{ color: "#fff" }}>Kirby's</span>{" "}
              <span style={{ color: "var(--accent)" }}>Heating & Air</span>
            </div>
            <p style={{ fontSize: 14, lineHeight: 1.7, color: "rgba(255,255,255,0.6)", marginBottom: 16, maxWidth: 320 }}>
              Family-owned HVAC service in North Little Rock, AR for over 50 years. Residential and commercial heating and air conditioning.
            </p>
            <p style={{ fontSize: 14, color: "rgba(255,255,255,0.6)", marginBottom: 6 }}>12006 MacArthur Dr, North Little Rock, AR 72118</p>
            <a href={TEL} style={{ fontSize: 14, color: "var(--accent)", fontWeight: 700 }}>{PHONE}</a>
            <p style={{ fontSize: 13, color: "rgba(255,255,255,0.45)", marginTop: 10 }}>Mon-Fri 8AM-4:30PM</p>
          </div>
          <div>
        ...
        <div className="footer-btm" style={{ maxWidth: 1200, margin: "0 auto", borderTop: "1px solid rgba(255,255,255,0.1)", paddingTop: 24, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <p style={{ fontSize: 13, color: "rgba(255,255,255,0.35)" }}>&copy; {yr} Kirby's Heating & Air Conditioning Inc. All rights reserved.</p>
      ...
      <div className="mobile-only" style={{ position: "fixed", bottom: 0, left: 0, right: 0, zIndex: 998, display: "none" }}>
        <a href={TEL} style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 10, background: "var(--accent)", color: "#fff", padding: "16px 20px", fontSize: 16, fontWeight: 700, fontFamily: "'DM Sans',sans-serif", boxShadow: "0 -4px 20px rgba(0,0,0,0.15)", textDecoration: "none" }}>
          {Icons.phone} Call Kirby's — {PHONE}
        </a>
      </div>
